	...
	
{
    ...
    //// add_admission_form/////
    public function 
        add_admission_form ($std_name_of_applicant,$std_date_of_birth,$std_father_name,$std_gender,$std_mobile_no,$std_address,$std_state)
	{
		$add_student_insert = "insert into st_info(st_name_of_applicant,st_date_of_birth,st_father_name,st_gender,st_mobile_no,st_address,st_state) value('$std_name_of_applicant,$std_date_of_birth,$std_father_name,$std_gender,$std_mobile_no,$std_address,$std_state)";
		$add_admission_form _run = $this->connectdb->query($add_admission_form );
		return $add_admission_form _run;
	}
