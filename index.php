...
<div class="main_section_agile" id="home">
	<div class="agileits_w3layouts_banner_nav">
		<nav class="navbar navbar-default">
			...
			<h1><a class="navbar-brand" href="index.html"><i class="fa fa-leanpub" aria-hidden="true"></i> Northern School</a></h1>
			...
			<ul class="agile_forms">
				<li><a class="active" href="login/studentms/admin/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Admin</a> </li>
            ...
            <ul class="agile_forms">
				<li><a class="active" href="login/studentms/user/login.php"><i class="fa fa-sign-in" aria-hidden="true"></i> Student login</a> </li>
			<!--	<li><a href="#" data-toggle="modal" data-target="#myModal3"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up</a> </li> -->
			</ul>
			...
			<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
				<nav class="link-effect-2" id="link-effect-2">
					<ul class="nav navbar-nav">
						...
						<li><a href="#team" class="effect-3 scroll">Lecturers</a></li>
...
<div class="about-bottom">
	<div class="col-md-6 w3l_about_bottom_left">
		<div class="video-grid-single-page-agileits">
			<div data-video="E91gAjunqOM" id="video"> <img src="images/Banner.jpg" alt="" class="img-responsive" /> </div>
		</div>
	...
	<div class="container">
		<div class="stats-info">
			...
			<div class="col-md-3 col-xs-3 stats-grid slideanim">
				...
				<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='315' data-delay='.5' data-increment="1">315</div>
		...
		<div class="w3layouts_header">
			<p><i class="fa fa-graduation-cap" aria-hidden="true"></i></p>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/Permanent_Campus_600x420.jpg" class="swipebox"><img src="images/Permanent_Campus_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				</a>
				</div>
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/AB1_600x420.png" class="swipebox"><img src="images/AB1_600x420.png" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/nub1_600x420.jpg" class="swipebox"><img src="images/nub1_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/aamra-honors-Northern-University_600x420.jpg" class="swipebox"><img src="images/aamra-honors-Northern-University_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/Nub Night views_600x420.jpg" class="swipebox"><img src="images/Nub Night views_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					...
					<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/Nub_front_view_1_600x420.jpg" class="swipebox"><img src="images/Nub_front_view_1_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/NUB_event_600x420.png" class="swipebox"><img src="images/NUB_event_600x420.png" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 col-xs-3 gallery-grid gallery1">
					<a href="images/MG_1434_600x420.jpg" class="swipebox"><img src="images/MG_1434_600x420.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>Northern School</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
	...
	<div class="container">
		...
		<div class="team-w3l-grid">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/Untitled_350x350.jpg" alt="">
				  <h5>Rayhan Ul Masood</h5>
				  <div class="about_opa">
					<p>Associate Professor & Head</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="https://www.facebook.com/head.cse.nub"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/Samsuddoha sir.jpg" alt="">
				  <h5>Samsuddoha Alam</h5>
				  <div class="about_opa">
					<p>Associate Professor</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="https://www.facebook.com/msdohanub"></a></li>
						<li><a class="fa fa-twitter" href="#"></a></li>
						<li><a class="fa fa-google" href="#"></a></li>
						<li><a class="fa fa-linkedin" href="#"></a></li>
						<li><a class="fa fa-pinterest-p" href="#"></a></li>
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/Ruhul-Amin-CSE_350x350.jpg" alt="">
				  <h5>Md.Ruhul Amin</h5>
				  <div class="about_opa">
					<p>Associate Professor</p>
					<ul class="fb_icons2 text-center">
		...
		<div class="team-w3l-grid grid-2-team">
			<div class="col-md-4 col-xs-4 about-poleft t1">
				<div class="about_img"><img src="images/Sanjida_CSE_350x350.jpg" alt="">
				  <h5>Sanjida Akter</h5>
				  <div class="about_opa">
			...
			<div class="col-md-4 col-xs-4 about-poleft t2">
				<div class="about_img"><img src="images/Tama_350x350.jpg" alt="">
				  <h5>Tamanna Afroz</h5>
				  <div class="about_opa">
					<p>Lecturer</p>
					<ul class="fb_icons2 text-center">
			...
			<div class="col-md-4 col-xs-4 about-poleft t3">
				<div class="about_img"><img src="images/Zarin_Tasnim_Rothy_350x350.jpg" alt="">
				  <h5>Zarin Tasnim Rothy</h5>
				  <div class="about_opa">
					<p>Lecturers</p>
					<ul class="fb_icons2 text-center">
						<li><a class="fa fa-facebook" href="#"></a></li>
...
<div><img src="images/nub map.png" alt=""></div>
		...
		<div class="agile_banner_bottom_grids">
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agilew3_contact">
					<h4>Address</h4>
					<p>Ashiyan City Rd, Dhaka, Bangladesh</p>
					<p></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right">
					<h4>Phone</h4>
					<p>9820859, 9821493-5<span><?php echo "Phone"; ?></span></p>
				</div>
			</div>
			<div class="col-md-4 col-xs-4 w3_agile_contact_grid">
				...
				<div class="agile_contact_grid_right agileits_w3layouts_right1">
					<h4>Email</h4>
					<p><a href="mailto:info@example.com">info@nub.ac.bd</a>
					</p>
				</div>
				<div class="clearfix"> </div>
			</div>
...
<!-- <div class="mapouter"><div class="gmap_canvas"><iframe class="gmap_iframe" width="100%" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="https://maps.google.com/maps?width=1920&amp;height=480&amp;hl=en&amp;q=Northern University Bangladesh parmanent campus&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"></iframe><a href="https://connectionsgame.org/">Connections NYT</a></div><style>.mapouter{position:relative;text-align:right;width:100%;height:480px;}.gmap_canvas {overflow:hidden;background:none!important;width:100%;height:480px;}.gmap_iframe {height:480px!important;}</style></div> -->
		...
		<div class="wthree_footer_grid_left">
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1">
				...
				<ul>
					...
					<li><i class="fa fa-angle-double-right" aria-hidden="true"></i><a href="#team" class="scroll">Lecturers</a></li>
			...
			<div class="col-md-3 col-xs-3 wthree_footer_grid_left1 wthree_footer_grid_right1">
				<h4>Contact Us</h4>
				<ul>
					<li><i class="fa fa-envelope-o" aria-hidden="true"></i><a href="mailto:info@example.com">info@nub.ac.bd</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>9820859, 9821493-5</li>
					<li><i class="fa fa-fax" aria-hidden="true"></i>Ashiyan City Rd, Dhaka, Bangladesh</li>
				</ul>
			</div>
			<div class="clearfix"> </div>
		</div>
...
<div class="w3layouts_copy_right">
	<div class="container">
		<p>© <?php echo $general_fetch['website_start']; ?> - 2023 Northern School. All rights reserved | Design by <a href="https://www.linkedin.com/in/md-ujjal-hossain-developer" target="_blank">Md Ujjal Hossain</a> Developed by Team-1</p>
	</div>
</div>
	<?php }?>
	<!-- //footer -->
